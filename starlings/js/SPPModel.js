...
function initSPPModel() {
	...
	*/
	...
	var pMaterial = new THREE.ParticleBasicMaterial( {size: 1, color: 0xffffff, map: THREE.ImageUtils.loadTexture("images/particle-grey.png"), blending: THREE.AdditiveAlphaBlending, transparent: true} );
