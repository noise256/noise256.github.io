...
Tree.prototype = {
	create:function() {
		var nodeMaterial = new THREE.PointCloudMaterial( {map: THREE.ImageUtils.loadTexture("images/particle-grey.png"), size: 100, color: 0xffffff, opacity: 1.0, transparent: true, blending: THREE.AdditiveBlending});
